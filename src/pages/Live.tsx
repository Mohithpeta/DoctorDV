          ...
          <div className="flex justify-between mb-6">
            ...
            <div className="flex space-x-4">
              <button
                ...
                className="px-4 py-2 bg-[#5E17EB] text-white rounded-full text-sm hover:bg-pink-600 transition"
              >
                Schedule a live
              </button>
              <button 
            ...
            {filteredSessions.map((session, index) => (
              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  <button className="px-4 py-2 text-pink-500 border border-pink-500 rounded-full text-sm hover:bg-[#5E17EB] hover:text-white transition">
                    Notify Me
                  </button>
                </div>
              </div>
